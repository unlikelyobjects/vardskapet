...
<section class="main-content">
	<div class="content-inner">
		<div class="grid-holder">
			<div class="grid-col-50 green-bg colored-box">
			...
			<div class="grid-col-50 blue-bg colored-box">
			...
			<div class="grid-col-100 teal-bg colored-box">
			...
			<div class="grid-col-33 services">
				<div class="icon icon-reel"></div>
				<div class="divider"></div>
				<h2>Dokumentär</h2>
...
<script src="/wp-content/themes/storefront/assets/js/sliders.min.js"></script>
<script>
	$ = jQuery;
