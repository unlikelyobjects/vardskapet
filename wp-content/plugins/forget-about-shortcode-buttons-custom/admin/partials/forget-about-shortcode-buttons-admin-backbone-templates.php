...
<div id="fasc-popup-edit-button" style="display:none;" data-fasc-title="Redigera knappen" data-fasc-width="480px" data-fasc-height="600px" data-fasc-submit-label="Uppdatera">
		...
		<div class="fasc-popup-toolbar">
			...
			<div class="fasc-popup-toolbar-button-row">
				...
				<div class="fasc-popup-colorpicker-container" data-fasc-colorpicker-name="fasc-background">
					<input type="text" id="fasc-popup-button-color" name="button-color" value="#29b15b" /><br />
					<input type="text" id="" class="fasc-popup-color-input" value="#29b15b" />
				</div>
				...
				<select name="button-type" id="fasc-popup-button-type">
					<option value="fasc-type-flat fasc-rounded-medium" selected="selected">Rund</option>
					<option value="fasc-type-flat">Fyrkantig</option>
<!-- 
...
<!-- 
					<option value="fasc-size-xsmall">XS</option>
					<option value="fasc-size-small">S</option>
 -->
					<option value="fasc-size-medium" selected="selected">M</option>
<!-- 
					<option value="fasc-size-large">L</option>
					<option value="fasc-size-xlarge">XL</option>
 -->
				</select>
		...
		<!-- <form action="/" method="get" accept-charset="utf-8"> -->
			...
			<div class="tab-header">
				<ul>
					<li data-fasc-tab="1" class="active">Egenskaper</li>
					<li data-fasc-tab="2">Ikon</li>
<!-- 
					<li data-fasc-tab="3">Mallar</li>
 -->
			...
			<div data-fasc-tab="1" class="fasc-tab-content">
				...
				<div class="inputrow main">
					...
					<div class="inputwrap">
						<input type="text" name="button-text" value="" id="fasc-popup-button-text" value="" placeholder="Skriv din text&hellip;" />
					</div>
					<div class="clear"></div>
				</div>
				<div class="inputrow main">
					...
					<div class="inputwrap">
						<label for="fasc-popup-nofollow"><small>+ Nofollow</small> &nbsp;<input type="checkbox" id="fasc-popup-nofollow" name="fasc-popup-nofollow" value="1" /></label>
						<label for="fasc-popup-new-window"><small>Öppna l&#228;nk i nytt f&#246;nster</small> &nbsp;<input type="checkbox" id="fasc-popup-new-window" name="fasc-popup-new-window" value="1" /></label>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="inputrow">
					<div class="inputwrap left">
						<select id="fasc-popup-icon-type-select">
							...
							<option value="fa-web-grid">Webb</option>
							<option value="fa-media-grid">Media</option>
							<option value="fa-form-grid">Form</option>
							<option value="fa-currency-grid">Valuta</option>
							<option value="fa-editor-grid">Redigerare</option>
							<option value="fa-directional-grid">Pilar</option>
							<option value="fa-brand-grid">Brand</option>
							<option value="fa-medical-grid">H&#228;lsa</option>
						</select>
						</label>
					</div>
					...
					<div class="inputwrap right">
						...
						<label><input type="radio" name="fasc-ico-position" value="none" class="fasc-ico-position" checked="checked" /> Ingen</label>
						<label><input type="radio" name="fasc-ico-position" value="before" class="fasc-ico-position" /> Innan</label>
						<label><input type="radio" name="fasc-ico-position" value="after" class="fasc-ico-position" /> Efter</label>
	...
	<div class="fasc-thickbox-frame-toolbar fasc-thickbox-footer">
		<div class="fasc-thickbox-toolbar">
			<p>
				...
				<a href="#" class="button-primary fasc-thickbox-action-right">L&#228;gg till</a>
